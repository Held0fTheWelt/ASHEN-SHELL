...
| Committed Turn Side-Effect Coordinator (`commit_hooks`) | `component` | Centralize callback, cascade, observability and optional W5 hook ordering | One compatibility seam; durable-order violation remains explicit as AR-V012 | [`world-engine/world_engine/story_runtime/manager/commit_side_effects.py`](../../../../world-engine/world_engine/story_runtime/manager/commit_side_effects.py) |
