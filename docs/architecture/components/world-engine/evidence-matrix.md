...
| --- | --- | --- | --- | --- |
| WE-M01 | Backend proxies play; engine owns commit | `world-engine/world_engine/story_runtime/manager/` | `world-engine/tests/test_story_runtime_api.py` | Implemented |
...
| WE-M05 | Single persist path per turn | `world-engine/world_engine/story_runtime/manager/` | `tests/gates/test_canonical_turn_lifecycle_gate.py` | Partial |
| WE-M08 | Preview stores isolated from live sessions | `world-engine/world_engine/story_runtime/manager/` | `world-engine/tests/test_preview_session_isolation.py` | Implemented |
| WE-M10 | Semantic ingress before structural guards | `world-engine/world_engine/story_runtime/` | `tests/gates/test_adr0055_semantic_ingress_gate.py` | Partial |
