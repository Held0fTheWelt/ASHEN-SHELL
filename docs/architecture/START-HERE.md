...
Fast entry for Better Tomorrow internal architecture work. Find the normative SAD, contract, UML
...
| Architecture drift / historical MVPs | [Drift reconciliation](evidence/architecture-drift-reconciliation.md) | [Git and archaeology baseline](evidence/architecture-drift-baseline.md) |
| Semantic UML landscape | [UML entry](../../UML/README.md) | [Architecture archaeology model](../../UML/Project/ecosystem-topology/components/architecture-archaeology.md) |
...
| Git/archaeology drift baseline | [Architecture drift baseline](evidence/architecture-drift-baseline.md) |
| Historical claim reconciliation and target directions | [Architecture drift reconciliation](evidence/architecture-drift-reconciliation.md) |
