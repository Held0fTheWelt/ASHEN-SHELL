...
| --- | ---: | --- |
| Confirmed current | 1 | Current code and accepted architecture agree. |
| Superseded | 2 | Historical evidence remains useful but has no current authority. |
| Conflicting | 4 | Concurrent structures or semantics need an explicit decision. |
| Open target | 5 | Repair evidence exists, but production-path proof is incomplete. |

## Reconciliation map

| ID | Concern | Status | Diagnosis | Target direction |
| --- | --- | --- | --- | --- |
| `DRIFT-001` | Competing live-runtime structures | `conflicting` | Two runtime package generations and an explicit legacy-method seam remain in executable source. Their allowed responsibilities are not yet enforced as one dependency direction. | Make app/story_runtime the only live-session authority. Reduce app/runtime to named infrastructure/profile adapters or retire each overlapping behavior. No compatibility path may commit session truth. |
...
| `DRIFT-006` | Manager decomposition contains generated-looking and legacy shards | `conflicting` | The manager is decomposed, but executable legacy loaders and numbered source shards obscure ownership and make static comprehension difficult. This is a characteristic Vibe-Coding accretion seam. | Replace dynamic legacy assembly with explicit cohesive modules organized by session lifecycle, turn execution, commit, projection and observability. Preserve behavior through characterization tests before each deletion. |
...
- [`world-engine/app/story_runtime/manager/runtime_manager.py`](../../../world-engine/app/story_runtime/manager/runtime_manager.py)
- [`world-engine/app/runtime/manager.py`](../../../world-engine/app/runtime/manager.py)
- [`world-engine/app/story_runtime/manager/_legacy_methods.py`](../../../world-engine/app/story_runtime/manager/_legacy_methods.py)

**Best target direction**

Make app/story_runtime the only live-session authority. Reduce app/runtime to named infrastructure/profile adapters or retire each overlapping behavior. No compatibility path may commit session truth.
...
- [`world-engine/app/story_runtime/narrative_commit_resolution.py`](../../../world-engine/app/story_runtime/narrative_commit_resolution.py)
- [`world-engine/app/story_runtime/canonical_turn_lifecycle.py`](../../../world-engine/app/story_runtime/canonical_turn_lifecycle.py)
...
- [`world-engine/app/story_runtime/manager/turn_execution.py`](../../../world-engine/app/story_runtime/manager/turn_execution.py)
- [`world-engine/app/story_runtime/manager/committed_dramatic_context.py`](../../../world-engine/app/story_runtime/manager/committed_dramatic_context.py)
- [`world-engine/app/story_runtime/manager/committed_dramatic_context_parts.py`](../../../world-engine/app/story_runtime/manager/committed_dramatic_context_parts.py)
...
- [`world-engine/app/content/backend_loader.py`](../../../world-engine/app/content/backend_loader.py)
...
- [`world-engine/app/story_runtime/manager/_legacy_sources/manifest.py`](../../../world-engine/app/story_runtime/manager/_legacy_sources/manifest.py)
- [`world-engine/app/story_runtime/manager/_legacy_loader.py`](../../../world-engine/app/story_runtime/manager/_legacy_loader.py)
- [`world-engine/app/story_runtime/manager/turn_execution.py`](../../../world-engine/app/story_runtime/manager/turn_execution.py)
- [`world-engine/app/story_runtime/manager/runtime_manager.py`](../../../world-engine/app/story_runtime/manager/runtime_manager.py)
...
- No runtime import executes _legacy_loader or numbered _legacy_sources.
- The manager dependency graph is acyclic and documented.
...
- [`world-engine/app/story_runtime/manager/story_window_entries.py`](../../../world-engine/app/story_runtime/manager/story_window_entries.py)
- [`world-engine/app/story_runtime/manager/player_visible_canonical_record.py`](../../../world-engine/app/story_runtime/manager/player_visible_canonical_record.py)
- [`frontend/static/play_block_renderer.js`](../../../frontend/static/play_block_renderer.js)
...
- [`world-engine/app/observability/trace.py`](../../../world-engine/app/observability/trace.py)
