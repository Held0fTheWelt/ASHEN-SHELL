...
| Backend Trace Start (`backend`) | `component` | Create or propagate player request identity | Stable trace and request ids | [`backend/app/api/v1/game_routes_impl.py`](../../../../backend/app/api/v1/game_routes_impl.py) |
