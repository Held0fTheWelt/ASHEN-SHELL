...
| MVP4-P06 | Operational wiring | `run-test.py`, workflows, TOMLs | Include diagnostics/trace/admin suites. | operational checks |
...
|---|---|---|
| `run-test.py` | include diagnostics, trace, and Narrative Gov suites | run-test log |
