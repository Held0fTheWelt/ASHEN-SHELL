...
- [ADR-0048: Central route and MCP rate-limit inventory](docs/architecture/components/mcp-server/architecture)
...
- [Security governance administration](../admin/security-governance.md)
- [ADR-0050: Security governance for browser mutation boundaries](docs/architecture/project/security-governance/architecture)
- [ADR-0051: Storage-layer encryption governance](docs/architecture/project/security-governance/architecture)
- [ADR-0052: Security Governance Admin Control Plane](docs/architecture/project/security-governance/architecture)
