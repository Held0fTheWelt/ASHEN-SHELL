...
- **Status:** Accepted — **Absorbed into** [world-engine SAD D3](../architecture/components/world-engine/architecture.md#d3-live-runtime-commit-semantics) (partial; open gaps documented there).
- **Date:** 2026-05-05
