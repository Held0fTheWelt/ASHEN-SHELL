...
Engineering governance for World of Shadows: ADRs, gate oracle discipline, audit resolution, and
architecture maintenance routes.
...
Audience onboarding remains under [`docs/start-here/`](../start-here/README.md). This folder is for
maintainers and operators, not players.
