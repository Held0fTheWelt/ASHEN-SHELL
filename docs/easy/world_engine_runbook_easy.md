...
**Repository anchors for this rule:** `docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine`, `world-engine/app/main.py`.
...
**Seams:** `docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine`, `world-engine/app/story_runtime/commit_models.py`.
