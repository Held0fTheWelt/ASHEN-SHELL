...
- **Not** “the runtime has a separate consumer brand today.” The **runtime** is the **engine room**; it does **not** need its own public trademark to be valuable ([`docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine) names **world-engine** as authority host—an engineering seam, not a second product logo).
...
**Anchor:** [`README.md`](../../README.md), ADR-0001 [`docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine).
...
-- **Play authority** lives in **`world-engine/`** per ADR-0001 ([`docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine)).
...
- **ADR-0001** places **live narrative authority** in **world-engine** ([`docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine)).
...
| Runtime authority | [`docs/architecture/components/world-engine/architecture.md#d1-runtime-authority-in-world-engine) |
