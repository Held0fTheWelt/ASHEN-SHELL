...
- Prevent accidental application of unvetted proposals to runtime state.
- Make tests and migration pathways explicit about origin of proposals.
- Improve auditability by recording a provenance enum on decisions.
...
`docs/archive/superpowers-legacy-execution-2026/plans/2026-03-29-w2-4-5-responder-only-gating.md` and related specs.
