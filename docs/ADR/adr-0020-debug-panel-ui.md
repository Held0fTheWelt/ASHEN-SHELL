...
- Exposes necessary diagnostic information to developers and QA without cluttering gameplay.
- Keeps the UI implementation simple and accessible (no JS required for basic interaction).
- Binds UI to a single canonical presenter output to avoid divergence and ensure testability.
...
`docs/archive/superpowers-legacy-execution-2026/specs/2026-03-30-w3-5-3-debug-panel-ui.md` (Design Decisions section).
