...
Examples:
  ...
  python despaghettify/tools/wave_plan_emit.py json2md \\
    --json despaghettify/tools/fixtures/despag_wave_plan_example_valid.json \\
    --out /tmp/wave_plan.md

  python despaghettify/tools/wave_plan_emit.py md2json --embed \\
    --md despaghettify/tools/fixtures/wave_plan_embed_example.md \\
