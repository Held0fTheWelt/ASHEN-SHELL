...
from app.model_governance.routing.operational_state import (
    OperationalState,
    classify_operational_state,
    pytest_session_active,
    rollup_no_eligible_discipline_for_bounded_traces,
)
from app.model_governance.routing.startup_profiles import resolve_startup_profile
from app.model_governance.routing.model_inventory_contract import InventorySurface
from app.model_governance.routing.model_inventory_report import validate_surface_coverage
from app.model_governance.model_routing_contracts import RouteReasonCode
from app.model_governance.routing.no_eligible_operator_meaning import (
    build_no_eligible_operator_meaning_payload,
)
from app.model_governance.routing.operator_audit import (
...
_CANONICAL_TASK2A_AUTHORITY_SUMMARY = (
    "Authoritative Task 2A policy: app.model_governance.model_routing.route_model. "
