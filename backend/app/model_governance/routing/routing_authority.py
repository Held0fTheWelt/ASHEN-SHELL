...
ROUTING_AUTHORITY_REGISTRY: tuple[RoutingAuthorityEntry, ...] = (
    RoutingAuthorityEntry(
        ...
        module_path="app.model_governance.model_routing.route_model",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.authoritative,
        module_path="app.model_governance.adapter_registry",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.authoritative,
        module_path="app.model_governance.model_routing_contracts",
    ...
    RoutingAuthorityEntry(
        ...
        module_path="app.model_governance.routing_registry_bootstrap",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.model_inventory_contract",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.model_inventory_report",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.model_routing_evidence",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.operator_audit",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.operator_truth",
    ...
    RoutingAuthorityEntry(
        ...
        layer=AuthorityLayer.non_authoritative_support,
        module_path="app.model_governance.routing.startup_profiles",
        description="Named startup profiles and expected bootstrap/registry facts for docs and gates.",
        canonical_for_task2a_paths=frozenset(CanonicalSurface),
    ),
    # Former backend Runtime staged turn executors retired in Wave 6 (dormant
    # cluster deletion). Live turn routing remains World-Engine / LangGraph.
    RoutingAuthorityEntry(
