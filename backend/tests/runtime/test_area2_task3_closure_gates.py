"""Area 2 Task 3 — operator comparison and readability closure (G-T3-01 … G-T3-08)."""
...
@pytest.mark.asyncio
async def test_g_t3_01_compact_truth_model_gate(
    app_bootstrap_on,
    client_bootstrap_on,
    ...
    assert_area2_truth_shape(synthetic)


@pytest.mark.asyncio
async def test_g_t3_02_direct_readability_gate(
    app_bootstrap_on,
    client_bootstrap_on,
    auth_headers_bootstrap_on,
):
...
def test_g_t3_03_policy_execution_comparison_gate():
...
@pytest.mark.asyncio
async def test_g_t3_04_cross_surface_comparison_gate(
    app_bootstrap_on,
    client_bootstrap_on,
    auth_headers_bootstrap_on,
):
...
@pytest.mark.asyncio
async def test_g_t3_05_primary_concern_visibility_gate(app_bootstrap_on, client_bootstrap_on, auth_headers_bootstrap_on):
...
@pytest.mark.asyncio
async def test_g_t3_06_no_deep_reconstruction_dependency_gate(
    app_bootstrap_on,
    client_bootstrap_on,
    auth_headers_bootstrap_on,
):
...
def test_g_t3_07_documentation_truth_gate():
...
def test_g_t3_08_authority_semantic_safety_gate():
