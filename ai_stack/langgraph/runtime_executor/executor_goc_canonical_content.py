...
SOURCE_LINES = [
    ...
    '            f"OUTPUT LANGUAGE: Write ALL visible text (narration_summary, spoken_lines[].text, action_lines[].text) in session_output_language={language}. "\n',
    '            "If session_output_language=de, write in German. If session_output_language=en, write in English. "\n',
    '            "Never default to English when another language is specified.",\n',
