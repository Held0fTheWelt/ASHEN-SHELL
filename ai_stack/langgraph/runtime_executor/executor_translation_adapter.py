...
SOURCE_LINES = [
    ...
    '            return update\n',
    '\n',
    '        _lang_label = {"de": "German", "en": "English", "fr": "French", "it": "Italian"}.get(input_lang, input_lang)\n',
    '        prompt = (\n',
    '            "JSON only.\\n"\n',
    '            f"Translate player input from {_lang_label} to English.\\n"\n',
    '            "If English, keep unchanged.\\n"\n',
    "            'Return {\"normalized_english_text\":\"<text>\",\"confidence\":\"high\"}\\n'\n",
    '            f"raw_player_text: {raw_pi}"\n',
    '        )\n',
    '        translation.update(\n',
    '            {\n',
