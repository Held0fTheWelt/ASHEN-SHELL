...
class ObservabilityStore:
    ...
    def record_command(self, *, suite: str, command: str, exit_code: int, duration_ms: int, ok: bool, warnings_count: int = 0, errors_count: int = 0, target_repo_id: str | None = None) -> None:
