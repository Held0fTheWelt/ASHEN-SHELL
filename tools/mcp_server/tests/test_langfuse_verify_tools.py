...
from tools.mcp_server.tests.langfuse_verify_runtime_aspect_fixture import (
...
def test_summarize_runtime_aspect_matrix_reads_ledger_from_path_summary():
    ...
    trace_payload = runtime_aspect_matrix_trace_payload()
    with patch(
        "tools.mcp_server.handlers.langfuse_verify._langfuse_get_trace",
        return_value=trace_payload,
    ):
    ...
    assert out["ok"] is True
    assert_runtime_aspect_matrix_row(out["rows"][0])
