...
| `docs/` | Human-facing docs, AKDB architecture specs, contracts, schema notes, operations, examples, and implementation planning. |
...
- [Architecture specs](docs/architecture/README.md)
- [Decision records](docs/decisions/README.md)
- [Implementation specs](docs/specs/README.md)
- [API and MCP contracts](docs/contracts/README.md)
- [SQLite schema](docs/schema/README.md)
...
In the Tiny Tool workspace, the public showcase repository lives outside this repo at `D:\TinyToolDevelopment\Git\Tools`, user-facing showcase scripts live under `D:\TinyToolDevelopment\Git\Tools\User`, and cross-project SAD/UML authority lives in `D:\TinyToolDevelopment\Git\docs` plus `D:\TinyToolDevelopment\Git\UML`.
