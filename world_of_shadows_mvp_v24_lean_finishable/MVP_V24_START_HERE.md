...
7. Use the audit prompt in `docs/73_V24_AUDIT_MASTERPROMPT.md`
8. Let the auditor choose the next implementation field and generate the concrete handoff for the implementation AI
