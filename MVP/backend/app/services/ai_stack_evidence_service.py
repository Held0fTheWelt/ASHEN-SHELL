...
def build_session_evidence_bundle(*, session_id: str, trace_id: str, allow_backend_local_fallback: bool = True) -> dict[str, Any]:
    ...
    if not engine_id and not allow_backend_local_fallback:
        return {
            "trace_id": trace_id,
            "error": "authoritative_world_engine_story_session_id_required",
            "session_id": session_id,
