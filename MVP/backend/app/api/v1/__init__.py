...
# Focused backend retirement validation may defer unrelated heavy AI/governance route imports.
import os
if os.getenv("WOS_SCOPED_BACKEND_TEST_IMPORTS") != "1":
    ...
    # Keep retirement-relevant and touched evidence routes only.
    pass
