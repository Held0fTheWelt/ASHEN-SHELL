...
def test_create_local_bootstrap_session_registers_session():
    from app.services.session_service import create_local_bootstrap_session
    session = create_local_bootstrap_session("god_of_carnage")
    assert session.module_id == "god_of_carnage"


def test_create_session_alias_delegates_to_local_bootstrap():
