...
In the lean v24 package, prefer **`python scripts/run_fy_governance_cycle.py`** or explicit `PYTHONPATH`-based suite calls. In fuller repository checkouts, editable-install bootstrap may also expose the `docify` console script.
