...
| Governance Attachment | `WORKSTREAM_GOVERNANCE_ATTACHMENT_STATE.md` | `artifacts/workstreams/governance_attachment/pre/` | `artifacts/workstreams/governance_attachment/post/` | Governed |
