...
- `python -m pytest tools/mcp_server/tests/test_mcp_operational_parity_and_registry.py ai_stack/tests/test_mcp_canonical_surface.py tools/mcp_server/tests/test_rpc.py backend/tests/runtime/test_mcp_enrichment.py -q --tb=short --no-cov`
