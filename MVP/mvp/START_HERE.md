...
This embedded MVP layer should be read as a single integrated MVP core with a current-state overlay inside the surrounding v24 lean package.
...
This embedded MVP layer still uses the v21 canonical target as its base.
The historical v22 delivery layer adds:
