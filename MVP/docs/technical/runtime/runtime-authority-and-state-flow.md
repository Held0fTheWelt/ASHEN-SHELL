...
The backend calls the play service using `PLAY_SERVICE_*` environment variables (see root `docker-compose.yml` and [`docs/dev/local-development-and-test-workflow.md`](../../dev/local-development-and-test-workflow.md)). Transitional backend session-shaped surfaces remain quarantined and non-authoritative; see [`../../ADR/adr-0002-backend-session-surface-quarantine.md`](../../ADR/adr-0002-backend-session-surface-quarantine.md) and [`../../../governance/V24_BACKEND_TRANSITIONAL_RETIREMENT_LEDGER.md`](../../../governance/V24_BACKEND_TRANSITIONAL_RETIREMENT_LEDGER.md). Do not duplicate runtime business logic in the backend without an ADR.
