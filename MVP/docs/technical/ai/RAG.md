...
- `docs/technical/**/*.md` — technical documentation (the canonical policy-guideline glob; former `docs/architecture/**/*.md` references are legacy compatibility only, not the governed ingest surface)
- `docs/reports/**/*.md` — review and evaluation artifacts where included by configuration
- `world-engine/app/var/runs/**/*.json` — repo-owned runtime transcripts used as supporting retrieval evidence
