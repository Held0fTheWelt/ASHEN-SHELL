...
Audience-first index for **active** documentation. Historical archive/audit trees are intentionally reduced in v24; the surviving `docs/archive/` and `docs/audit/` paths are lean tombstones for carry-forward clarity, not full historical restores.
...
- [`docs/presentations/`](presentations/) — lean tombstone only in this curated package
...
- Lean carry-forward map: [`governance/V24_SOURCE_PRESERVATION_LEDGER.md`](../governance/V24_SOURCE_PRESERVATION_LEDGER.md)
- Tombstone topic map: [`docs/archive/documentation-consolidation-2026/TOPIC_CONSOLIDATION_MAP.md`](archive/documentation-consolidation-2026/TOPIC_CONSOLIDATION_MAP.md)

## Legacy `docs/architecture/`

The folder now holds a **redirect** only: [`docs/architecture/README.md`](architecture/README.md). Active technical files moved to [`docs/technical/`](technical/); historical closure material is intentionally not restored in full and is represented by lean tombstones under [`docs/archive/architecture-legacy/`](archive/architecture-legacy/).
