...
Zuordnung folgt der in der erzeugten Spec sichtbaren Tag-Gliederung. Der Generator, aus dem diese Taxonomie ursprünglich hervorgeht, ist in diesem lean MVP nicht mitgeführt; die Taxonomie bleibt deshalb eine dokumentierte Projektion der aktuell mitgelieferten Spec.
...
- `openapi.yaml` ist in diesem MVP als mitgelieferte Artefaktkopie vorhanden. Eine vollständige In-Package-Regeneration ist hier nicht nachgewiesen.
- Re-Audits sollen stattdessen prüfen, ob die mitgelieferte Taxonomie noch zur aktuellen Spec und zu den Postman-Projektionen passt.
