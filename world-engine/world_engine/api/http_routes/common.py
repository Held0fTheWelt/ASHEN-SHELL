...
from world_engine.config import PLAY_SERVICE_INTERNAL_API_KEY
from world_engine.repo_root import resolve_wos_repo_root
from world_engine.narrative.corrective_retry import apply_corrective_retry
from world_engine.narrative.fallback_generator import build_safe_fallback_output
from world_engine.narrative.output_validator import validate_runtime_output
...
from world_engine.narrative.runtime_output_models import RuntimeTurnStructuredOutputV2
from world_engine.narrative.validation_feedback import ValidationFeedback
from world_engine.narrative.validator_strategies import OutputValidatorConfig
from world_engine.runtime.manager import RuntimeManager
from world_engine.story_runtime import StoryRuntimeManager
from world_engine.story_runtime.live_governance import LiveStoryGovernanceError
from world_engine.story_runtime.manager import StorySessionContractError
...
def _get_validator_config(request: Request) -> OutputValidatorConfig:
    ...
    if config is None:
        from world_engine.narrative.validator_strategies import ValidationStrategy
