...
import world_engine.config  # noqa: F401 — load_dotenv so WOS_REPO_ROOT from .env is visible
...
from world_engine.ui_backend_proxy import backend_proxy_response, user_capabilities
...
from world_engine.narrative.validator_strategies import OutputValidatorConfig, ValidationStrategy
from world_engine.runtime.json_at_rest import JsonAtRestCodec
from world_engine.runtime.manager import RuntimeManager
from world_engine.runtime.runtime_config_client import (
