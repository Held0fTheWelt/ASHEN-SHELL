# MVP Completion - End-to-End Turn

**Viewpoint:** `sequence`
**Concern:** One real turn preserves semantics and evidence to the player surface

[PlantUML source](end-to-end-turn.puml)
...
| Authoritative Commit | Apply accepted dramatic outcome to live truth | World-engine-only commit | [`world-engine/app/story_runtime/narrative_commit_resolution.py`](../../../../world-engine/app/story_runtime/narrative_commit_resolution.py) |
