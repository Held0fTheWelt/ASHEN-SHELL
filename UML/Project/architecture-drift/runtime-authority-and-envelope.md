...
| --- | --- | --- | --- | --- | --- | --- |
| `runtime-compatibility-delegation` | `world-engine:runtime` | `world-engine:manager` | `compatibility_delegate` | `DRIFT-001`, `DRIFT-006` | `validated_command` | [`world-engine/app/runtime/manager.py`](../../../world-engine/app/runtime/manager.py) |
...
| `validated-content-to-world-loader` | `content-authority:validator` | `content-authority:world_loader` | `content_projection` | `DRIFT-004` | `content_version`, `source_provenance` | [`world-engine/app/content/backend_loader.py`](../../../world-engine/app/content/backend_loader.py) |
...
| `committed-state-to-delivery` | `world-engine:store` | `world-engine:delivery` | `visible_projection` | `DRIFT-003`, `DRIFT-005`, `DRIFT-007` | `selected_scene_function`, `primary_responder_id`, `beat_progression`, `visible_blocks`, `speaker_identity` | [`world-engine/app/story_runtime/manager/story_window_entry_parts.py`](../../../world-engine/app/story_runtime/manager/story_window_entry_parts.py) |
| `delivery-to-frontend-stream` | `world-engine:delivery` | `frontend:stream` | `visible_projection` | `DRIFT-007` | `visible_blocks`, `speaker_identity` | [`world-engine/app/api/story_ws.py`](../../../world-engine/app/api/story_ws.py) |
...
| `trace-ai-to-operator-projection` | `observability-traceability:ai` | `observability-traceability:projection` | `evidence_flow` | `DRIFT-008` | `trace_id`, `completeness`, `redaction_status` | [`world-engine/app/web/static/ui_traces.js`](../../../world-engine/app/web/static/ui_traces.js) |
...
| --- | --- | --- | --- |
| `live-story-session-json-save-callsite` | `live_story_session` | `self._session_store.save` | `world-engine/app/story_runtime/manager/session/manager_init_and_persistence.py::_persist_session` |
