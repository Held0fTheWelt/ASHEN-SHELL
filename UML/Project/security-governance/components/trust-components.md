...
| Provider Credential Service | Seal, rotate and resolve provider secrets | No plaintext persistence or response | [`backend/app/services/governance/governance_runtime_service_impl.py`](../../../../backend/app/services/governance/governance_runtime_service_impl.py) |
| Runtime Secret Resolver | Provide ephemeral secret material to authorized calls | Scoped in-memory use | [`backend/app/services/governance/governance_runtime_service_impl.py`](../../../../backend/app/services/governance/governance_runtime_service_impl.py) |
