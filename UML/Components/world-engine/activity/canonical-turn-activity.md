# World Engine - Canonical Turn Activity

**Viewpoint:** `activity`
**Concern:** Decision points between proposal, rejection, commit and delivery

[PlantUML source](canonical-turn-activity.puml)
