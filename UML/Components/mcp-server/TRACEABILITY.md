...
| --- | --- | --- | --- |
| [MCP Server - Context](context/mcp-context.md) | `context` | D1 | `backend/app/api/v1/__init__.py`, `tools/mcp_server/README.md`, `tools/mcp_server/backend_client.py`, `tools/mcp_server/handlers/tools_registry_handlers_backend_session.py`, `tools/mcp_server/server.py`, `world-engine/world_engine/api/http.py` |
