...
| --- | --- | --- | --- |
| [Story Runtime Core - Authority Context](context/story-runtime-core-context.md) | `context` | D1 | `ai_stack/story_runtime/player_action_resolution.py`, `story_runtime_core/__init__.py`, `world-engine/world_engine/story_runtime/governed_runtime_adapters.py` |
