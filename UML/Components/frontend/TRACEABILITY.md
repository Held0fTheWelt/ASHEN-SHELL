...
| --- | --- | --- | --- |
| [Frontend - System Context](context/frontend-context.md) | `context` | D1 | `backend/app/api/v1/__init__.py`, `backend/app/services/game/game_service.py`, `frontend/app/__init__.py`, `frontend/app/api_client.py`, `frontend/app/routes.py`, `frontend/templates/session_shell.html`, `world-engine/app/api/story_ws.py` |
