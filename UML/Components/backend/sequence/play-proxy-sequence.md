...
| Backend | Game API | routes authenticated player turn | validated game API request | [`backend/app/api/v1/game_routes_impl.py`](../../../../backend/app/api/v1/game_routes_impl.py) |
