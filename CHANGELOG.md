...
- **Despaghettify thresholds:** **`M7_ref`** recomputed for adjusted per-category bars (**C2=8, C3=25, C6=14, C7=10**, …) → **≈ 14.1%**; composite and scan-only wording updated in [`spaghetti-check-task.md`](despaghettify/spaghetti-check-task.md); trigger table + **Otherwise** clause aligned in [`despaghettification_implementation_input.md`](despaghettify/despaghettification_implementation_input.md) and [`templates/despaghettification_implementation_input.EMPTY.md`](despaghettify/templates/despaghettification_implementation_input.EMPTY.md); minor Markdown cleanup in the check task.
