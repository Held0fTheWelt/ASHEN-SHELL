...
- **Docify unit tests:** [`'fy'-suites/docify/tools/tests/`]('fy'-suites/docify/tools/tests/__init__.py) (drift classification, audit behaviour, hub **`open-doc`** smoke).
...
- **Docify default AST audit scope:** [`'fy'-suites/docify/tools/python_documentation_audit.py`]('fy'-suites/docify/tools/python_documentation_audit.py) now includes **`'fy'-suites/docify`** in the default **`--root`** set so routine audits self-cover the hub; [`AGENTS.md`](AGENTS.md) and [`'fy'-suites/docify/README.md`]('fy'-suites/docify/README.md) describe the updated behaviour (this supersedes the **`[0.6.3]`** note that excluded the Docify tree from default scans).
...
- **Docify hub tools:** `python -m pytest "'fy'-suites/docify/tools/tests" -q` (from repo root, after **`pip install -e .`**) — passed in CI per [`.github/workflows/docify-skills-validate.yml`](.github/workflows/docify-skills-validate.yml).
